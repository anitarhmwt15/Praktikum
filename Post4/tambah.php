...
<body>
	...
	if ($_SERVER["REQUEST_METHOD"] == "POST") {
		...
		if ($flag) {
			...
			$sql = "INSERT INTO mahasiswa (nim, nama, jkel, alamat, tgllhr, nohp) VALUES('$nim', '$nama', '$jkel','$alamat', '$tgllhr', '$nohp') ";
			// execute sql insert
	...
	<form action=" <?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST">
		...
		<table>
                ...
                <tr>
					<td>No Hp : </td>
					<td><input type="text" name="nohp" placeholder="No Hp"></input></td>
                    <span class="error"> <?= $nohpErr; ?></span>
				</tr>
				<td>
				<td>
